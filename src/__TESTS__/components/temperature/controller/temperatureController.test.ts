...
describe('*temperature*', () => {
    ...
    describe('GET TEMPERATURE', () => {
        it('Should return 200 with empty array', async () => {
            ...
            const { getTemperature } = new TemperatureController(
    ...
    describe('POST TEMPERATURE', () => {
        it('Should return 201', async () => {
            ...
            const { postTemperature } = new TemperatureController(
                mockTemperatureService
            )
    ...
    describe('PATCH TEMPERATURE', () => {
        it('Should return 200', async () => {
            ...
            const { updateTemperature } = new TemperatureController(
                mockTemperatureService
            )
    ...
    describe('DELETE TEMPERATURE', () => {
        it('Should return 200', async () => {
            ...
            const { deleteTemperature } = new TemperatureController(
                mockTemperatureService
            )
